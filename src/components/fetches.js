...
const BACK_URL = process.env.BACK_URL || "http://206.189.60.189:8080";
...
export const checkToken = async (accessToken, refreshToken) => {
  ...
  try{
    const response = await fetch(BACK_URL+'/refresh-token', {
      method: 'POST',
      headers: headers,
...
export const afterRegistration = (card_id, birth_date, image) => {
  ...
  return fetch(BACK_URL+'/after-reg', {
    method: 'POST',
    headers: headers,
    body: JSON.stringify(data),
  })
...
export const getImage = (card_id) => {
  ...
  return fetch(BACK_URL+'/get-image', {
    method: 'POST',
    headers: headers,
    body: JSON.stringify(data),
  })
...
export const getBirthDate = (card_id) => {
  ...
  return fetch(BACK_URL+'/get-birthday', { 
    method: 'POST', 
    headers: headers, 
    body: JSON.stringify(data), 
  })  
...
export const checkPinCode = (card_id, pin_code) => {
  ...
  return fetch(BACK_URL+'/check-pincode', {
    method: 'POST',
    headers: headers,
    body: JSON.stringify(data),
  })
...
export const updatePassword = (card_id, new_password) => {
  ...
  return fetch(BACK_URL+'/update-password', {
    method: 'POST',
    headers: headers,
    body: JSON.stringify(data),
  })
...
export const takeUserData = () => {
  ...
  return fetch(BACK_URL+'/get-user-data', {
    method: 'GET',
    headers: headers,
  })
}
...
export const getCourses = () => {
  ...
  return fetch(BACK_URL+'/get-courses', {
    method: 'GET',
    headers: headers,
  })
}
...
export const generateCode = (course_code) => {
  ...
  return fetch(BACK_URL+'/generate-code', {
    method: 'POST',
    headers: headers,
    body: JSON.stringify(data),
  })
...
export const takeAttendance = (generateCode, course) => {
  ...
  return fetch(BACK_URL+'/card-entry-in', {
    method: 'POST',
    headers: headers,
    body: JSON.stringify(data),
  })
...
export const getStatus = (course_code, course_type) => {
  ...
  return fetch(BACK_URL+'/get-status', {
    method: 'POST',
    headers: headers,
    body: JSON.stringify(data),
  })
